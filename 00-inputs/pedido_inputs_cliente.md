# Pedido de elementos — Dra. Júlia Best

**Estado: MINUTA PARA REVISÃO DO RUI. Não enviada.**
Rever tom e confirmar a contagem de prazo antes de enviar. Data prevista de envio: a definir.

---

## Texto de acompanhamento (email)

> **Assunto:** Elementos necessários para concluir a análise — Dra. Júlia Best
>
> Cara Dra. Júlia,
>
...
## Anexo — Elementos a fornecer

### 1. Código de atividade do cônjuge *(prioritário — dois minutos)*
...
### 3. Tabela de preços por serviço

Preço e duração por tipo de sessão, mesmo que ainda provisória. A ata regista que não existe tabela formalmente definida, apesar de já haver faturação — é um dos pontos a fechar de qualquer modo.

---

### 4. Encargos dos dois espaços em avaliação

Para **cada um** dos espaços (2 e 3 gabinetes):
...
### 5. Orçamento de obras e equipamento, com IVA discriminado
...
### 6. Condições com os fisioterapeutas a integrar
...
### 7. Atividade e enquadramento fiscal do cônjuge

Além do código de atividade (ponto 1): faturação anual, regime em que está enquadrado, e se está sujeito a IVA ou isento.

---

### 8. Rendimentos do agregado e composição familiar
...
### 9. Proposta do investidor para aquisição do espaço, se existir

A proposta escrita, ou os termos discutidos. Se não houver nada de concreto, basta dizer-nos que não existe.

**Nota de âmbito:** a negociação com o investidor e a avaliação imobiliária não fazem parte deste trabalho. O que precisamos é do efeito nos números: valor da renda, duração, e se está prevista alguma forma de aquisição futura.

---

### 10. Quanto do lucro precisa de levantar por ano
...
- A contagem dos 60 dias arranca com o envio. Registar a data no dossiê e agendar ponto de situação ao dia 30 (R1-28).
- Confirmar com o Rui se a menção às janelas de março e junho deve ficar no corpo do email ou passar para o anexo. Fica no email porque é o que a cliente lê; mas é uma advertência forte para uma segunda interação.
